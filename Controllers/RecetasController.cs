...
namespace reportesApi.Controllers
{
    ...
    public class RecetasController: ControllerBase
    {
        ...
        [HttpPost("InsertRecetas")]
        public IActionResult InsertRecetas([FromBody] RecetasModel entradas )
        {
            ...
            try
            {
                ...
                objectResponse.message = _RecetasService.InsertRecetas(entradas);
        ...
        public IActionResult UpdateRecetas([FromBody] RecetasModel entradas )
        {
            var objectResponse = Helper.GetStructResponse();
            try
            {
                objectResponse.StatusCode = (int)HttpStatusCode.OK;
                objectResponse.success = true;
                objectResponse.message = _RecetasService.UpdateRecetas(entradas);
        ...
        [HttpDelete("sp_delete_recetas/{id}")]
